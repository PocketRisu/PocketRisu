...
export const languageEnglish = {
    ...
    requestStatusDisplayMode: "Request Status Display",
    requestStatusModeModal: "Modal",
    requestStatusModeDetailed: "Detailed output",
    requestStatusModeNone: "None",
    requestStatus: {

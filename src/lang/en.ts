...
export const languageEnglish = {
    ...
    pluginStorageDeleteFiltered: "Delete Filtered",
    pluginStorageDeleteFilteredConfirm: (count: number) => `Delete all ${count} filtered keys? This cannot be undone.`,
    pluginStorageDeletedCount: (count: number) => `Deleted ${count} keys.`,

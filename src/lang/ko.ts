...
export const languageKorean = {
  ...
  modelPresetFolderDefault: "새 폴더",
  modelPresetFolderName: "폴더 이름",
  modelPresetFolderRename: "폴더 이름 바꾸기",
  modelPresetFolderDelete: "폴더 삭제",
  modelPresetFolderDeleteConfirm: "이 폴더를 삭제할까요? 폴더 안의 프리셋은 현재 위치에 그대로 유지됩니다.",
  modelPresetFolderEmpty: "이 폴더에 프리셋이 없습니다",
  modelPresetDropCreateFolder: "폴더 만들기",
  modelPresetDropIntoFolder: "폴더로 이동",
  basicSettings: "기본 설정",
  backToList: "목록으로",

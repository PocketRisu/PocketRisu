...
export const languageKorean = {
  ...
  pluginStorageDeleteFiltered: "필터링된 항목 삭제",
  pluginStorageDeleteFilteredConfirm: (count: number) => `필터링된 ${count}개의 항목을 모두 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.`,
  pluginStorageDeletedCount: (count: number) => `${count}개의 항목이 삭제되었습니다.`,

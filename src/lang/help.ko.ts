...
export const helpKo = {
        ...
        "useGlobalSettings": "이 캐릭터의 개별 값 대신 앱 전체 로어북 설정을 사용합니다. 끄면 이 캐릭터에만 적용되는 값을 설정할 수 있습니다.",
        "loreBookDepth": "활성화 키를 검색할 최근 사용자·캐릭터 메시지 수입니다. 예: `5`는 최근 5개 메시지를 검색하고, `0`은 채팅 검색을 끕니다. (0-20)",
        "loreBookToken": "한 번의 응답에서 활성화된 로어북에 허용할 최대 토큰입니다. 한도를 넘으면 우선순위가 낮은 항목부터 제외됩니다. (0-4096)",

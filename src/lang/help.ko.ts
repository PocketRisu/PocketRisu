...
export const helpKo = {
        ...
        "recursiveScanning": "활성화된 로어북 내용으로 다른 항목을 연쇄 활성화합니다. 예: Alice 항목에 Bobby가 있으면 다음 재귀 단계에서 Bobby 항목을 활성화할 수 있습니다.",
        "maxRecursionSteps": "로어북 검색 단계를 제한합니다. `1`은 채팅에서 직접 찾은 항목만, `2`는 활성화된 내용이 한 번 더 찾은 항목까지 포함하며, `0`은 무제한입니다.",

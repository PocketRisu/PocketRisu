...
export const helpKo = {
        ...
        "lorebookMatchingMode": "활성화 키를 찾는 방법입니다.\n\n- **부분 문자열:** 더 긴 단어 안에서도 찾습니다. `cat`은 `category`와 매칭됩니다.\n- **공백 단위 완전 일치:** 키 앞뒤에 공백이 필요합니다. `cat`은 `cat runs`와 매칭되지만 `cat, runs`와는 매칭되지 않습니다.\n- **유니코드 단어 경계:** 문장부호와 한국어 조사를 허용하고 더 긴 단어는 제외합니다. `Alice`는 `(Alice)`와, `앨리스`는 `앨리스가`와 매칭되지만 `Alice`는 `Aliceville`과 매칭되지 않습니다.",
